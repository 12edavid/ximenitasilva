...
var animate = (function() {
	...
	function hasUnsubscribed() {
		...
		subtitle.innerHTML = "Por favor reconsidera tu respuesta, no dejes que mi corazón de pollo lo hagan chicharrón .";
	...
	function hasCancelled() {
		...
		subtitle.innerHTML = "Eres lo más bonito que tengo,la luz que vuelve habitable cada esquina de mi alma.No lo olvides, amor!";
		unsubscribeButton.style.display = 'none';
		cancelButton.style.display = 'none';
		goBackButton.style.display = 'block';
		clicked = true;
